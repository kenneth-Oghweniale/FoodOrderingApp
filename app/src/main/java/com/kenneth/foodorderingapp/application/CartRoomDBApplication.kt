package com.kenneth.foodorderingapp.application
 ...
 */
class CartRoomDBApplication : Application() {
     ...
     */
    private val database by lazy { CartDataBase.getDatabase(this@CartRoomDBApplication) }
